...
An opinionated, minimal [cookiecutter](https://github.com/aalmero/cookiecutter) template for Python packages, and some guidelines for Python packaging.

Usage
-----

    pip install cookiecutter
    git clone https://github.com/aalmero/cookiecutter-pypackage-minimal-mod.git
    cookiecutter cookiecutter-pypackage-minimal-mod/
...
The decisions `cookiecutter-pypackage-minimal-mod` makes should all be explained here.
